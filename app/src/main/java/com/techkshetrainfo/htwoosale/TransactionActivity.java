...
public class TransactionActivity extends AppCompatActivity implements
    ...
    private TransactionActivity.MyPagerAdapter mPagerAdapter;
...
//        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(TransactionActivity.this, SaleActivity.class));
...
//                        .setAction("Action", null).show();
        ...
        mPagerAdapter = new TransactionActivity.MyPagerAdapter(getSupportFragmentManager());
